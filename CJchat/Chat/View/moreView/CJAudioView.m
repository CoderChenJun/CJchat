...
@interface CJAudioView ()<AVAudioPlayerDelegate,CJRecordManagerDelegate>
{
    UILabel * _nameLabel;
...
- (void)setSubView:(CGRect)frame
{
    ...
    nameLabel.textColor = CJHexColor(0x535f62);
    ...
    progressV.progressTintColor =  CJColor(13, 103, 135);
    ...
    endTimeLabel.textColor = CJHexColor(0x535f62);
...
- (void)setAudioPath:(NSString *)audioPath
{
    ...
    NSUInteger durataion = [[CJRecordManager shareManager] durationWithVideo:[NSURL fileURLWithPath:audioPath]];
    _endTimeLabel.text = [CJMessageHelper timeDurationFormatter:durataion];
}
...
{
    [self timerInvalid];
     [[CJRecordManager shareManager] stopPlayRecorder:_audioPath];
    CJRecordManager *manager = [CJRecordManager shareManager];

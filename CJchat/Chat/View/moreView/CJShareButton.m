...
- (void)setMessageModel:(CJMessageModel *)messageModel
{
    ...
    CJMessage *message = messageModel.message;
...
- (UILabel *)nameLabel
{
    if (!_nameLabel) {
        ...
        label.textColor = CJHexColor(0x262626);
...
- (UILabel *)descLabel
{
    if (!_descLabel) {
        ...
        label.textColor = CJHexColor(0x707070);
...
- (UILabel *)fromLabel
{
    if (!_fromLabel) {
        ...
        label.textColor = CJHexColor(0x9d9d9d);
        [self addSubview:label];
        _fromLabel = label;
    }
    return _fromLabel;
...
- (UIView *)lineView
{
    if (!_lineView) {
        ...
        view.backgroundColor = CJHexColor(0xc4c4c4);

...
@implementation CJMessageTopView
                   ...
                   date:(NSInteger)date
{
    // 时间改成服务器的时间
    _isSender = isSender;
    NSString *currentDate      = [CJMessageHelper timeFormatWithDate:date];
    if (isSender) {
...
- (UILabel *)nameLabel
{
    if (!_nameLabel) {
        ...
        label.textColor = CJHexColor(0x929292);
...
- (UIView *)lineView
{
    if (!_lineView) {
        ...
        line.backgroundColor = CJHexColor(0xa8bd61);

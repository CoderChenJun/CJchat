...
- (void)clearReuseImageMessage:(CJMessageModel *)message
{
                                  ...
                                  isSender:(BOOL)isSender
{
    ...
    if (videoImg) {
        UIImage *addImage = [UIImage addImage:[UIImage imageNamed:@"App_video_play_btn_bg"] toImage:videoImg];
    ...
    UIImage *resultImg = [UIImage addImage:[UIImage imageNamed:@"App_video_play_btn_bg"] toImage:videoArrowImage];
    if (resultImg) {
...
- (NSString *)saveImage:(UIImage *)image
{
    ...
    // 图片名称
    NSString *fileName = [NSString stringWithFormat:@"%@%@",[NSString currentTimeString],@".png"];
...
{
    NSString *path = [[CJFileTool cacheDirectory] stringByAppendingPathComponent:kVideoPic];
    [self fileManagerWithPath:path];
                                     ...
                                     type:(NSString *)type
{
    ...
    NSString *mainFilePath = [self createFolderPahtWithMainFolder:[CJFileTool cacheDirectory] childFolder:kMyPic];
...
{
    return [[[CJFileTool cacheDirectory] stringByAppendingPathComponent:kMyPic] stringByAppendingPathComponent:imageName];
}


// origin image path
- (NSString *)originImgPath:(CJMessageFrame *)messageF
{
    return [[CJMediaManager sharedManager] receiveImagePathWithFileKey:messageF.model.message.fileKey type:@"origin"];
}

// small image path
- (NSString *)smallImgPath:(NSString *)fileKey
{
    return [[CJMediaManager sharedManager] receiveImagePathWithFileKey:fileKey type:@"small"];
}
...
- (NSString *)delieveImagePath:(NSString *)fileKey
{
    ...
    NSString *mainFilePath = [self createFolderPahtWithMainFolder:[CJFileTool cacheDirectory] childFolder:kDeliver];
    return [mainFilePath stringByAppendingPathComponent:fileName];
}

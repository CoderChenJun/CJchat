...
+ (NSArray *)emojiEmotion
{
    ...
    _emojiEmotions  = [CJEmotion mj_objectArrayWithKeyValuesArray:[NSArray arrayWithContentsOfFile:path]];
    return _emojiEmotions;
}
...
+ (NSArray *)customEmotion
{
    ...
    _custumEmotions = [CJEmotion mj_objectArrayWithKeyValuesArray:[NSArray arrayWithContentsOfFile:path]];
    return _custumEmotions;
}
                                          ...
                                          lineHeight:(CGFloat)lineHeight
{
    ...
    for (NSTextCheckingResult *match in resultArray) {
        ...
        NSArray *faceArr = [CJFaceManager customEmotion];
        for (CJEmotion *face in faceArr) {

...
- (void)presentFromVideoView:(UIView *)fromView
    ...
    CGFloat height = fromView.size.height * UISCREEN_WIDTH / fromView.size.width;
    ...
    [UIView animateWithDuration:oneTime animations:^{
        self.playerLayer.frame = CGRectMake(0, UISCREEN_HEIGHT / 2 - height / 2, UISCREEN_WIDTH, height);
        self.alpha = 1;
    }];
